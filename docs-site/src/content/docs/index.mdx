---
title: Valkey Admin
description: A powerful desktop administration tool for Valkey clusters with real-time monitoring, key management, and cluster visualization.
template: splash
hero:
  tagline: Monitor, manage, and interact with your Valkey instances and clusters through an intuitive desktop application.
  image:
  ...
  actions:
    - text: Documentation
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/valkey-io/valkey-admin
      icon: external
      variant: minimal
---
...
<CardGrid>
	...
	<Card title="Command Interface" icon="rocket">
...
<Tabs>
  ...
  <TabItem label="Command Interface">
    ![Interactive command terminal with syntax highlighting and auto-completion](../../assets/command.png)

    **User friendly command interface** with syntax highlighting, response searching and command history.
  </TabItem>
